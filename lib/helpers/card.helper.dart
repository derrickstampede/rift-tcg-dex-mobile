...
Future<Either<Map<String, dynamic>, dynamic>> findCard({required String id}) async {
  try {
    ...
    final card = CardItemView(
      ...
      isSigned: responseData['data']['card']['is_signed'],
      ...
      domain: responseData['data']['card']['domain'],
      energy: responseData['data']['card']['energy'],
      might: responseData['data']['card']['might'],
      power: responseData['data']['card']['power'],
      ability: responseData['data']['card']['ability'],
      flavorText: responseData['data']['card']['flavor_text'],
      tags: responseData['data']['card']['tags'],
      ...
      variants:
          responseData['data']['card']['variants'].map<CardVariant>((v) => CardVariant.fromJson(v)).toList()
              as List<CardVariant>,
      cardsProfiles:
          responseData['data']['card']['cardsProfiles'] != null
    ...
    final translation =
        responseData['data']['translation'] != null
...
Future<Either<Map<String, dynamic>, dynamic>> findCardMany({required String ids}) async {
  try {
    final headers = {...httpHeaders};
    Session? session = supabase.auth.currentSession;
    if (session != null) {
    ...
    final cards =
        responseData['data']['cards'].map<CardCheck>((dynamic c) {
          return CardCheck(
            id: c['id'],
            name: c['name'],
            cardId: c['card_id'],
