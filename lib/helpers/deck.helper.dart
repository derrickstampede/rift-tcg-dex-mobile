  ...
  try {
    ...
    final deck = Deck(
      ...
      leader: CardListItem(
        ...
        domain: deckData['leader']['domain'],
        energy: deckData['leader']['energy'],
        might: deckData['leader']['might'],
        rarity: deckData['leader']['rarity'],
        power: deckData['leader']['power'],
        count: deckData['leader']['count'],
        print: deckData['leader']['print'],
        orientation: deckData['leader']['orientation'],
