...
// import 'package:rift/screens/battle/select-deck.screen.dart';
...
class FluroRoutes {
  static void configureRouter(FluroRouter router) {
    ...
    router.define('/card/full', handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      String? image;
    ...
    router.define('/card/stock', handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    ...
    router.define('/decks/new', handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const NewDeckScreen();
    }), transitionType: TransitionType.native);
    router.define('/decks/select-leader',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const SelectLeaderScreen();
    }), transitionType: TransitionType.native);
    router.define('/decks/edit', handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      String slug = '';
      String? name;
      String? color;
      if (params['slug'] != null) {
    ...
    router.define('/decks/pick', handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      String? slug;
      String? color;
      if (params['slug'] != null) {
        slug = params['slug'].first;
    ...
    router.define('/vaults/form', handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      String? slug;
      if (params['slug'] != null) {
        slug = params['slug'].first;
      }
    ...
    router.define('/vaults/view', handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    ...
    router.define('/vaults/add-cards',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      String slug = params['slug'].first;
    ...
    router.define('/profile/update',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const UpdateProfile();
    }), transitionType: TransitionType.native);
    router.define('/profile/update-username',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const UpdateUsername();
    }), transitionType: TransitionType.native);

    router.define('/profile/settings',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const SettingsScreen();
    }), transitionType: TransitionType.native);
    router.define('/profile/settings/user-preferences',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const UserPreferenceScreen();
    }), transitionType: TransitionType.native);
    router.define('/profile/settings/trial-code',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const TrialCodeScreen();
    }), transitionType: TransitionType.native);
    router.define('/profile/settings/consent-manager',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
      return const ConsentManagerScreen(); 
    }), transitionType: TransitionType.native);

    router.define('/subscription/learn-more',
        handler: Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
