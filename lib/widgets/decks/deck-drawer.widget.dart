...
class DeckDrawer extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DeckDrawer> createState() => _DeckDrawerState();
}

class _DeckDrawerState extends ConsumerState<DeckDrawer> {
              ...
              children: <Widget>[
                ...
                CurrencyDropdown(
                  ...
                  onChange: (int? selectedCountry) {
                    ...
                    ref.watch(deckBuildNotifierProvider(widget.slug).notifier).updateCountryId(selectedCountry);
  ...
  Future<void> _showPriceBreakdown({required Deck deck, required String slug}) async {
                      ...
                      cards.isNotEmpty
                          ? ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              final int? countryId = ref.watch(deckBuildNotifierProvider(widget.slug))!.countryId;
                              ...
                              return ListTile(
                                ...
                                trailing: SizedBox(
                                  ...
                                  child: CardPrice(
                                    price: price,
                                    currency: symbol,
                                    replaceSymbol: _isPro && countryId != null ? conversions$.symbol : null,
                                    fontSize: 15,
                    ...
                    children: [
                      ListTile(
                        ...
                        trailing: SizedBox(
                          width: 100,
                          child:
                              _isPro && ref.watch(deckBuildNotifierProvider(widget.slug))!.countryId != null
                                  ? CardPrice(
                                    price:
                                        total *
  ...
  Widget build(BuildContext context) {
    ...
    if (deck$ == null || conversions$.isLoading) {
                        ...
                        ListTile(
                          ...
                          onTap:
                              market.isPro && !_isPro
                                  ? null
                                  : () {
                                    _showPriceBreakdown(deck: deck$, slug: market.slug);
                                  },
                        ),
                    ],
                  ),
